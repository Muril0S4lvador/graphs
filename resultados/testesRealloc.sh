...
output_file="ResultsRealloc.csv"

# Cria um arquivo vazio para as saídas consolidadas
> "$output_file"
echo "Nome;Cost Before VNS;Cost After VNS;Possibility;Optimal cost;Optimal distance Before VNS;Optimal distance After VNS" >> "$output_file"
